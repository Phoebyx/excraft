...
Bullet points marked with ? are possibilities.
Needs testing !

* [Inventory:] 
  * Consequences for death/being in dimension when reset
  * Temporary or limited use items
...
* [Uncategorized:]
  * Nether as unlock
  * Compass points towards portal
  * Base Defense in Overworld
  * Prevent mobs from spawning otherwise
  * Dimensional Events and Effects ?
    * Stink Cloud (he farted) - Green tint in atmosphere + Poison
    * ...
  * Interesting but still resourceless terrain in overworld.
  * Timer in UI
  * Expedition Count
